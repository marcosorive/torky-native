    ...
    render(){
        return(
            <View style={{flex:1, justifyContent:"flex-end",  backgroundColor:"#efefef"}}>
                ...
                <P>Si eres dev o simplemente te gusta la tecnología te cuento un poco más como está hecho esto. El back-end está hecho en python sobre Flask. Había trabajando antes con Django y me apetecía probar otro framework. Para el front-end he usado ReactJS y Bootstrap. La aplicación para móviles está hecha con React Native. Para obtener los precios he creado un web scrapper usando BeautifulSoup4. Las webs de fnac, corte inglés e Instant gaming fueron muy fáciles de scrappear, la de Game me está costando un poco. Si quieres contactar conmigo por cualquier razón busca abajo el apartado de contacto.</P>
